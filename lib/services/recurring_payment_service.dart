...
/// month, based on their default frequency, skipping weekends/holidays and
/// never duplicating a day that already has a payment recorded.
class RecurringPaymentService {
  static Future<int> generateForMonth(Driver driver, DateTime monthAnchor) async {
    ...
    switch (driver.defaultFrequency) {
      ...
      case PaymentFrequency.monthly:
        final hasMonthPayment =
            existing.any((p) => p.date.year == year && p.date.month == month);
        if (!hasMonthPayment) {
